...
export default function bootstrapSample(){
    return (
        <div>
            ...
            <h1>Sample H1 heading text</h1>
            <br />

            <h2>Sample H2 heading text</h2>
            <br />

            <h3>Sample H3 heading text</h3>
            <br />

            <h4>Sample H4 heading text</h4>
            <br />
            ...
            <button type="button" className="btn btn-primary">Primary (Normal)</button>
            <button type="button" className="btn btn-secondary">Secondary (Normal)</button>
            <button type="button" className="btn btn-success">Success (Normal)</button>
            <button type="button" className="btn btn-info">Info (Normal)</button>
            <button type="button" className="btn btn-warning">Warning (Normal)</button>
            <button type="button" className="btn btn-danger">Danger (Normal)</button>
            <button type="button" className="btn btn-link">Link (Normal)</button>
            </p>

            <p className="bs-component">
            <button type="button" className="btn btn-primary disabled">Primary (Disabled)</button>
            <button type="button" className="btn btn-secondary disabled">Secondary (Disabled)</button>
            <button type="button" className="btn btn-success disabled">Success (Disabled)</button>
            <button type="button" className="btn btn-info disabled">Info (Disabled)</button>
            <button type="button" className="btn btn-warning disabled">Warning (Disabled)</button>
            <button type="button" className="btn btn-danger disabled">Danger (Disabled)</button>
            <button type="button" className="btn btn-link disabled">Link (Disabled)</button>
            </p>

            <p className="bs-component">
            <button type="button" className="btn btn-outline-primary">Primary (Outlined)</button>
            <button type="button" className="btn btn-outline-secondary">Secondary (Outlined)</button>
            <button type="button" className="btn btn-outline-success">Success (Outlined)</button>
            <button type="button" className="btn btn-outline-info">Info (Outlined)</button>
            <button type="button" className="btn btn-outline-warning">Warning (Outlined)</button>
            <button type="button" className="btn btn-outline-danger">Danger (Outlined)</button>
            </p>
            ...
            <div className="col-lg-12">
            <div className="page-header">
            <h1 id="tables">Tables (Striped)</h1>
            </div>
            ...
            <Table striped>
                <thead>
                    <tr>
                        ...
                        <th>Heading 3</th>
                        <th>Heading 4</th>
                        <th className="date">Date Column*</th>
                        <th className="numericSameLength">Numeric 1**</th>
                        <th className="numericVariedLength">Numeric 2***</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        ...
                        <td className="date">1/1/2020</td>
                        <td className="numericSameLength">2</td>
                        <td className="numericVariedLength">8288</td>
                    </tr>
                    <tr>
                        <td>Cell content 1</td>
                        <td>Cell content 2</td>
                        <td>Cell content 3</td>
                        <td>Cell content 4</td>
                        <td className="date">2/2/2020</td>
                        <td className="numericSameLength">4</td>
                        <td className="numericVariedLength">67845</td>
                    </tr>
                    <tr>
                        <td>Cell content 1</td>
                        <td>Cell content 2</td>
                        <td>Cell content 3</td>
                        <td>Cell content 4</td>
                        <td className="date">3/3/2020</td>
                        <td className="numericSameLength">6</td>
                        <td className="numericVariedLength">121</td>
                    </tr>
                    <tr>
                        <td>Cell content 1</td>
                        <td>Cell content 2</td>
                        <td>Cell content 3</td>
                        <td>Cell content 4</td>
                        <td className="date">4/4/2020</td>
                        <td className="numericSameLength">8</td>
                        <td className="numericVariedLength">23426654</td>
                    </tr>
                </tbody>
            </Table>
            * className = "date"<br />
            ** className = "numericSameLength"<br />
            *** className = "numericVariedLength"<br />
            <br />
            <br />

            <div className="page-header">
            <h1 id="tables">Tables (indicator rows)</h1>
            </div>
            ...
            <button type="button" className="btn btn-secondary" title="" data-container="body" data-toggle="popover" data-placement="left" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus." data-original-title="Popover Title">Left</button>

            <button type="button" className="btn btn-secondary" title="" data-container="body" data-toggle="popover" data-placement="top" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus." data-original-title="Popover Title">Top</button>

            <button type="button" className="btn btn-secondary" title="" data-container="body" data-toggle="popover" data-placement="bottom" data-content="Vivamus
