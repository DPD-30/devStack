...
public class FormLogin {
	...
	public void formLogin(String nodeURL, String url, String username, String password) throws InterruptedException, MalformedURLException {
		report = new ExtentReports("C:\\Users\\caciuser\\LocalDev\\caci\\challengeDEV\\challenge\\selenium\\trunk\\SeleniumTestNG\\caciChallenge\\log\\loginLogout.FormLogin.html");
		logger = report.startTest("Verify Form Login");
		// driver, nodeURL
