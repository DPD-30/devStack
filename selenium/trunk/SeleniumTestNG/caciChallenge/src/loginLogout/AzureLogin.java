...
public class AzureLogin {
	...
	public void azureLogin(String nodeURL, String url, String username, String password) throws InterruptedException, MalformedURLException {
		report = new ExtentReports("C:\\Users\\caciuser\\LocalDev\\caci\\challengeDEV\\challenge\\selenium\\trunk\\SeleniumTestNG\\caciChallenge\\log\\loginLogout.AzureLogin.html");
		logger = report.startTest("Verify Azure Login");
		// driver, nodeURL
		...
		Thread.sleep(1000);
		WebElement adminLoginBtn = driver.findElement(By.xpath("//button[contains(text(),'Admin Logout')]"));
